...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/15 11:09:31 by ymanzi            #+#    #+#             */
/*   Updated: 2020/12/15 11:09:33 by ymanzi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Often imitated (ScavTrap) !!" << std::endl;
}

ScavTrap::~ScavTrap( void )
{
	std::cout << "Some People like to call me SC4V-Mi-NA-TOR !! " << std::endl;
}
